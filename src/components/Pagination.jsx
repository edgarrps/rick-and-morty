...
export default function Pagination({ info, setPageNumber }) {

    return (
        <div className='flex justify-center pt-5 pb-20'>
            <ReactPaginate className='inline-flex items-center lg:space-x-6 md:space-x-2 sm:space-x-1' 
            ...
            nextLabel={'Avançar'} 
            pageClassName='hover:shadow-2xl hover:scale-105 text-center lg:w-[26px] lg:h-[24px] md:w-[20px] md:h-[24px] space-between text-white font-bold rounded bg-cyan-400' 
